...
<head>
    ...
    <script type="text/javascript">
        ...
        //验证码
        /*function test(){
            $("#imgVcode").prop("src","getKaptcha.do?t="+new Date().getTime());
        };*/
    </script>
</head>
<body>
<div id="top"></div>
<form id="login" name="login" action="selectUser.do" method="post">
    <div id="center">
        ...
        <div id="center_middle">
            ...
            <div class="chknumber">
                <label>验证码：
                    <input name="yzm" type="text" id="chknumber" maxlength="4" class="chknumber_input"/>
                </label><img width="100" height="60" src="getKaptcha.do" id="imgVcode"
                             onclick="document.getElementById('imgVcode').src='getKaptcha.do?time='+(new Date()).getTime();"/>
            </div>
        </div>
